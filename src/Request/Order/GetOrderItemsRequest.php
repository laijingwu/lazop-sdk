...
use Lazada\OpenPlatform\Response\Order\GetOrderItemsResponse;

class GetOrderItemsRequest extends AbstractLazopRequest
{
    protected $apiEndpointUri = LazopEndpoint::ORDER_GET_ORDER_ITEMS_URI;
    ...
    {
        return $this->response = new GetOrderItemsResponse($this, parent::sendData($data));
    }
